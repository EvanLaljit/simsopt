...
from simsopt.solve import relax_and_split_stochastic, relax_and_split
...
out_dir = Path("output_permanent_magnet_QA_convex_stochastic")
...
for i in range(relax_and_split_iteration):
    ...
    RS_history, m_history, m_proxy_history = relax_and_split_stochastic(pm_opt, -b_vec, m0=m0, **kwargs)
