...
out_dir_path = f"output_stage_two_optimization_stochastic_{CONFIG_NAME}_{N_SAMPLES}nsamp_LW_{LENGTH_WEIGHT}_CCDW_{CC_WEIGHT}"

if fourier_fit == True:
    out_dir_path += "_ffit"
    
if SIGMA_INITIAL_GUESS == 0:
    out_dir_path += "_original_3cm_sigma_max"
